...
values(1,'vivo','phone',1000),
(2,'oppo','phone',2000),
(3,'sony','tv',4000),
(4,'samsung','phone',3000)
...
insert into orders
values(1,'rakuna','2025-08-15',1800.00),
(2,'kunal','2025-08-17',1400.00),
(3,'steve','2025-08-20',2500.75),
(4,'root','2025-08-22',320.50)
...
insert into books
values(12,'johnwick','shishira',855.25),
(11,'avengers','ritesh',1200.50),
(9,'war','roashan',1700.75),
(8,'raaz','emran',1800.80)
...
INSERT INTO NotNULLTest(ID,Name) --Id can't be null this is why it is not executed
SELECT NULL,'John'

INSERT INTO NotNULLTest(ID,Name) -- name can take null value beacuase we don't give any constraint to the name column
SELECT 3,NULL
...
INSERT INTO UniqueTest(Id,name) -- unique constraint can take only one null value 
SELECT Null,'John'
...
INSERT INTO ForeignKeyTest(Id,DOB)
SELECT NULL,'2019-01-10' -- IT WILL TAKE AS A ORPHAN RECORD
...
INSERT INTO CheckTest(Id,Salary)
SELECT 3,-2000  --condition not supported
...
-- Alias column name of Employee Table

select 
emp.EmployeeFirstName as FirstName,
emp.EmployeeLastName as LastName 
from 
Employee emp
...
(2016,'Anant','anant15@yahoo.com',21)
